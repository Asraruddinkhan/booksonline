...
<br>
<br>
    <h1><font color="white" >Asrar Bookstore</font></h1>
    <nav>
      <ul>
        <li style="acolor:white"><a href="index.html">Home</a></li>
        <li><a href="http://localhost/books/login.php">Login</a></li>
	<li><a href="http://localhost/books/signup.php">SignUp</a></li>
        <li><a href="#">Contact</a></li>
	<li><a href="#">Genre List</a></li>
	<li><a href="#">Cart</a></li>
	<li><a href="http://localhost/books/adminlogin.php">Admin</a></li>
      </ul>
    </nav>
  </header>
    <!-- login form  -->
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    ...
                    <div class="content">
                        ...
                        <a href="payment.php" class="btn">add to cart</a>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <div class="icons">
